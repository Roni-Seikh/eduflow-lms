...
-- ============================================================
-- COURSES TABLE  (includes is_closed from the start — no later ALTER needed)
-- ============================================================
...
-- ============================================================
-- LECTURE COMPLETIONS TABLE  (created from the start)
-- ============================================================
...
-- ============================================================
-- NOTIFICATIONS TABLE  (includes recipient_role + 'admin' enum values
--                       from the start — no later ALTER needed)
-- ============================================================
CREATE TABLE IF NOT EXISTS notifications (
    id INT AUTO_INCREMENT PRIMARY KEY,
    sender_id INT DEFAULT NULL,
    sender_role ENUM('admin','faculty','student') DEFAULT 'admin',
    recipient_type ENUM('all','students','faculty','individual','admin') DEFAULT 'all',
    recipient_id INT DEFAULT NULL,
    recipient_role ENUM('student','faculty','admin') DEFAULT NULL,
    title VARCHAR(200) NOT NULL,
...
SELECT 'EduFlow LMS schema created successfully.' AS status;
